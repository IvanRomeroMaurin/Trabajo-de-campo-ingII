...
export class CrearComunidadDto implements ICreateCommunityRequest {
  @ApiProperty({ example: 'Comunidad de NestJS', description: 'Nombre de la comunidad' })
  @IsString()
  @IsNotEmpty({ message: 'El nombre de la comunidad es obligatorio' })
  @MaxLength(100, { message: 'El nombre no puede superar los 100 caracteres' })
  nombre: string;

  @ApiProperty({ example: 'Una comunidad para aprender NestJS', description: 'Descripción opcional', required: false })
  @IsOptional()
  @IsString()
  descripcion?: string;
  ...
  @ApiProperty({ example: 'https://ejemplo.com/imagen.jpg', description: 'URL de la imagen de portada', required: false })
  @IsOptional()
  @IsString()
  portada_url?: string;
}
