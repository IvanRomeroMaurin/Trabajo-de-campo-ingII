...
export function FinalCTA() {
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-48 text-center relative overflow-hidden bg-slate-50 border-t border-slate-200">
      ...
      <div className="absolute inset-0 hero-aura opacity-50" />
      
      <div className="max-w-4xl mx-auto relative z-10">
        <h2 className="font-display text-5xl md:text-7xl font-black text-slate-950 tracking-tight mb-10 leading-tight">
          ¿Listo para <span className="text-sky-600">escalar</span> tu futuro?
        </h2>
        <p className="text-slate-600 text-xl leading-relaxed mb-16 max-w-2xl mx-auto font-medium">
