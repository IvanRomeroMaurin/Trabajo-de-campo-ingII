...
export default function RegisterPage() {
  return (
    <div className="flex flex-col items-center justify-center py-12 px-6">
      <div className="glass-card max-w-lg w-full p-10 py-12 border border-slate-100">

        <div className="text-center mb-10">
          <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-sky-500 to-cyan-500 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-sky-500/20">
